...
| **W5** | `cv-cdp-url-guard` | cdp-url / freshness 门闩复核 | **LIVE** | W1 | `test:cdp-url` · `test:freshness` exit 0 |
| **W6** | `cv-catalog-budget` | catalog budget 门闩 | **LIVE** | W1 | `test:catalog-budget` · quality arina-only |
| **W7** | `cv-launcher-tray-stability` | launcher/tray 第一方源小稳 | QUEUED | W4 优先 | 小 diff · 无第二守护 |
| **W8** | `cv-core-runtime-boundary` | core↔runtime 依赖方向审计 | **LIVE** | — | `test:deps` 0 + 审计表 |
