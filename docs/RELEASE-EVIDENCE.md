...
- **v7 squash 合入 main（2026-07-21）**：PR [#2](https://github.com/xvyimu/Codex-Dream-Skin/pull/2) · merge `66853e8` · themes-gate PR [run 29823854183](https://github.com/xvyimu/Codex-Dream-Skin/actions/runs/29823854183) success · main push [run 29823905716](https://github.com/xvyimu/Codex-Dream-Skin/actions/runs/29823905716) success · 本机 `probe-project-hd` pass=true
