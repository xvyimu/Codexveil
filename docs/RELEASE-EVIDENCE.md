...
- **v6 squash 合入 main（2026-07-21）**：PR [#1](https://github.com/xvyimu/Codexveil/pull/1) · merge `b80bf4e` · themes-gate PR [run 29814826310](https://github.com/xvyimu/Codexveil/actions/runs/29814826310) success · main push [run 29814915657](https://github.com/xvyimu/Codexveil/actions/runs/29814915657) success（**仅 npm test**，不证明 CDP 视觉）
...
- **v7 squash 合入 main（2026-07-21）**：PR [#2](https://github.com/xvyimu/Codexveil/pull/2) · merge `66853e8` · themes-gate PR [run 29823854183](https://github.com/xvyimu/Codexveil/actions/runs/29823854183) success · main push [run 29823905716](https://github.com/xvyimu/Codexveil/actions/runs/29823905716) success · 本机 `probe-project-hd` pass=true
